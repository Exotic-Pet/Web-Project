            ...
            <main className="container grid justify-center grid-cols-12 mx-auto mt-32 mb-32 gap-x-[50px]">
                    ...
                    <form action="" className="flex justify-around">
                        <div className="relative">
                            <input type="text" placeholder="搜尋"
                                className="text-brown-normal text-xl rounded-full border border-brown-normal py-[5px] pl-5 focus:outline-green-normal" />
                ...
                <section className="col-span-9 tracking-wide">
                    ...
                    <div className="flex justify-between">
                        <div className="w-[281px] h-[58px] bg-brown-light flex items-center rounded-t-[20px]" id='groundGecko'>
                    ...
                    <div className="bg-green-light rounded-[22px] rounded-tl-none pt-[45px] pb-[54px] px-4">
                        <div className="flex justify-center mx-[93px] mb-6">
                            ...
                            <figure className="flex justify-center bg-white gap-x-3 ml-[18px] rounded-[10px] w-full items-center">
                                ...
                                <h3 className="text-2xl font-bold text-green-dark whitespace-nowrap">地棲守宮</h3>
                                <img src={titleDeco} alt="deco" className="w-[21px]" />
                            </figure>
                        </div>
                        <Swiper
                        ...
                        className="mb-4 mySwiper mg max-w-[900px]"
                        breakpoints={{
                            390:{
                                slidesPerView: 1,
                            },
                    ...
                    <div className="flex justify-between mt-6">
                        <div className="w-[281px] h-[58px] bg-brown-light flex justify-around items-center rounded-t-[20px]" id='groundedLizard'>
                            <div className="flex">
                                <div className="w-3 h-3 rounded-full bg-traffic-red"></div>
                                <div className="w-3 h-3 mx-2 rounded-full bg-traffic-yellow"></div>
                                <div className="w-3 h-3 rounded-full bg-traffic-green"></div>
                    ...
                    {/*turtle*/}
                    <div className="flex justify-between mt-6">
                        <div className="w-[281px] h-[58px] bg-brown-light flex justify-around items-center rounded-t-[20px]" id='groundedTurtle'>
                            <div className="flex">
                                <div className="w-3 h-3 rounded-full bg-traffic-red"></div>
                                <div className="w-3 h-3 mx-2 rounded-full bg-traffic-yellow"></div>
                                <div className="w-3 h-3 rounded-full bg-traffic-green"></div>
                    ...
                    {/*snake*/}
                    <div className="flex justify-between mt-6">
                        <div className="w-[281px] h-[58px] bg-brown-light flex justify-around items-center rounded-t-[20px]" id='groundedSnake'>
                            <div className="flex">
                                <div className="w-3 h-3 rounded-full bg-traffic-red"></div>
                                <div className="w-3 h-3 mx-2 rounded-full bg-traffic-yellow"></div>
                                <div className="w-3 h-3 rounded-full bg-traffic-green"></div>
